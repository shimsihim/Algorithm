...
단순 BFS문제이다. <br/>
주어진 간선들에 대해서 ArrayList배열을 만든 후 방문 체크 배열을 만들어준다. <br/>
1을 큐에 넣고 bfs를 돌리는데 이때 q에 새로 삽입 시 해당 거리를 체크하여 새로운 최대값이면 초기화 해주고<br/>
최대값과 동일하다면 +1을 해주며 전체를 반복한다.
